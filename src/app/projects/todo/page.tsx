...
export default function TodoPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center px-6 py-20">
      <Navbar />
      <h1 className="text-3xl font-bold text-blue-400 mb-6">To-Do List</h1>
      ...
      <div className="w-full max-w-md bg-white/10 p-6 rounded-xl">
        <div className="flex gap-2 mb-4">
          ...
          <button
            onClick={addTask}
            className="px-6 py-3 bg-gradient-to-r from-blue-700 to-sky-400 rounded-lg font-medium hover:opacity-90 transition"
          >
